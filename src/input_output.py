...
# TODO: Эти функции нигде не используются. Если они не нужны, убери их, если нужны, скажи, где их будешь использовать
...
def end_game():
    ...
    try:
        vvod = int(input())
        if vvod == 1:
            # TODO: Как я понимаю, тут ты хочешь вывести все покупки. Тогда тебе нужно будет
            #  сделать хранение этих покупок где-либо
            #Вывод попкупок
            pass
        elif vvod == 2:
            render_menu()
